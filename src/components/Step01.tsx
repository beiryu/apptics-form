...
export default function Step01({ onNext }: Step01Props) {
  return (
    <div className="w-full h-screen flex flex-col items-center rounded-2xl bg-whitesmoke-100 border-whitesmoke-200 border-solid border-[1px] box-border overflow-hidden text-center text-sm text-dimgray font-inter">
      ...
      <main className="absolute top-40 left-0 right-0 flex items-center justify-center w-full px-4">
        <section className="flex flex-col items-center gap-8 w-full max-w-[1000px]">
          ...
          <div className="flex items-start gap-2 shrink-0 text-left text-[88px] text-darkslategray font-geist">
            ...
            <div className="h-20 w-[292px] overflow-hidden flex items-center justify-center">
              <Image
                ...
                className="h-full w-full object-cover [transform:scale(1.035)] mt-4"
                width={292}
                height={80}
                sizes="100vw"
                alt=""
          ...
          {/* Description */}
          <div className="w-full max-w-2xl text-xl tracking-[-0.02em] leading-6 text-slategray shrink-0">
