...
export default function Step11({ onNext }: Step11Props) {
  return (
    <div className="relative w-full h-screen flex flex-col rounded-2xl bg-whitesmoke-100 border-whitesmoke-200 border-solid border-[1px] box-border overflow-hidden text-center text-[42px] text-darkslategray font-geist">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-col items-center justify-center gap-4 text-base text-white font-inter">
              ...
              >
                ...
                <span className="flex-1 tracking-[-0.03em] leading-[22px] font-medium text-white [text-shadow:0px_1px_1.5px_rgba(0,_0,_0,_0.12)] text-left">
              ...
              <button
                onClick={onNext}
                className="w-[350px] rounded-2xl [background:linear-gradient(180deg,_rgba(235,_237,_240,_0.25),_rgba(235,_237,_240,_0))] border-gray border-solid border-[1px] box-border overflow-hidden flex items-center justify-center py-3 px-5 cursor-pointer transition-all duration-200 ease-in-out hover:scale-[1.02] hover:shadow-sm hover:bg-opacity-40 active:scale-[0.98]"
              >
                <span className="tracking-[-0.03em] leading-7 font-medium text-black [text-shadow:0px_1px_1.5px_rgba(0,_0,_0,_0.12)]">
                  Maybe Later
                </span>
              </button>
            </div>
      ...
      <ProgressIndicators currentStep={11} />
    </div>
  );
}
