  ...
  return (
    <div className="relative w-full h-screen flex flex-col rounded-num-16 bg-transparent box-border overflow-hidden text-center text-[42px] text-darkslategray font-geist">
      ...
      <main className="flex-1 flex items-start justify-center w-full px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-32 lg:pt-[200px] pb-20 sm:pb-24 md:pb-32 lg:pb-[200px] overflow-y-auto">
        <section className="flex flex-col items-center justify-between gap-4 sm:gap-5 w-full max-w-3xl">
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8">
            ...
            {/* Options Grid */}
            <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8 text-left text-sm sm:text-num-15 text-white font-inter">
