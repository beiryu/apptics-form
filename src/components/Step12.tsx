...
export default function Step12({}: Step12Props) {
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-6 sm:gap-8 w-full max-w-4xl -mt-60 md:-mt-24 lg:-mt-32">
      {/* Header Section */}
      <header className="flex flex-col items-center gap-4 sm:gap-6 w-full text-center">
        <h1 className="w-full text-2xl md:text-3xl lg:text-4xl xl:text-[42px] tracking-[-0.07em] leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-[48px] font-medium font-geist px-2 sm:px-0">
        ...
        <div className="rounded-[15px] bg-transparent flex items-center justify-center py-3 sm:py-[15px] px-3 sm:px-2.5 text-sm sm:text-base text-cornflowerblue-100 font-inter w-full max-w-2xl">
          <p className="w-full tracking-[-0.02em] leading-5 sm:leading-6 font-medium">
            ...
            identify revenue leaks, and show the exact system we use to scale
            for 7–8 figure brands.
          </p>
        </div>
      </header>
      ...
      <form className="flex flex-col items-stretch gap-3 sm:gap-4 w-full max-w-md text-left text-sm sm:text-[15px]">
        ...
        <div className="w-full rounded-num-16 bg-darkslategray-300 border-darkslategray-200 border-solid border-[1px] flex items-center p-1 sm:p-[5px] gap-2 sm:gap-2.5 text-sm text-white">
          ...
          >
            ...
            <span
              className={`tracking-num--0_03 leading-5 font-medium [text-shadow:0px_1px_1.5px_rgba(0,_0,_0,_0.12)] transition-opacity duration-150 ease-in-out ${
                contactMethod === 'telegram' ? 'opacity-100' : 'opacity-num-0_5'
              }`}
            >
              Telegram
            </span>
          ...
          >
            ...
            <span
              className={`tracking-num--0_03 leading-5 font-medium [text-shadow:0px_1px_1.5px_rgba(0,_0,_0,_0.12)] transition-opacity duration-150 ease-in-out ${
                contactMethod === 'phone' ? 'opacity-100' : 'opacity-num-0_5'
              }`}
            >
              Phone Number
            </span>
        ...
        <div className="w-full rounded-num-16 bg-darkslategray-300 border-darkslategray-200 border-solid border-[1px] box-border overflow-hidden flex items-center py-3 px-4 gap-2.5 transition-all duration-150 ease-in-out focus-within:border-cornflowerblue-100 focus-within:shadow-[0px_0px_0px_3px_rgba(78,168,247,0.1)]">
          ...
          <input
            ...
            placeholder={
              contactMethod === 'telegram' ? '@username' : '+1 (555) 123-4567'
            }
            value={contactInfo}
