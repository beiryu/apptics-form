...
export default function Step02({ onNext, onStepClick }: Step02Props) {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col rounded-2xl bg-transparent box-border overflow-hidden text-center text-2xl sm:text-3xl md:text-4xl lg:text-[42px] text-darkslategray font-geist">
