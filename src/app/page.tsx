  ...
  return (
    <div className="relative w-full h-screen flex flex-col rounded-2xl bg-transparent box-border overflow-hidden">
      <AnimatePresence mode="wait" custom={direction}>
        ...
        >
          <main className="flex-1 flex items-center md:items-start justify-center w-full h-full px-4 sm:px-6 lg:px-8 pt-[80px] pb-4 md:pt-36 md:pb-36 overflow-y-auto">
            {renderStep()}
          </main>
        </motion.div>
      </AnimatePresence>
